...
help me with something quick, I'll let you borrow my boat and you can go visit the gardener. 
...
a list of winning numbers and then a list of numbers you have. You organize the information 
...
This time, the above example goes differently:
  ...
  - Your one instance of card 6 (one original) has no matching 
    numbers and wins no more cards.
...
and 1 instance of card 6. In total, this example pile of scratchcards causes you to 
